...
const Apps: React.FC = () => {
  return (
    <div className="min-h-screen bg-surface">
      ...
      {/* CricketBolt */}
      <section className="relative overflow-hidden py-32">
        <div className="absolute inset-0 bg-gradient-to-br from-surface via-[#0a1a0a]/[0.08] to-surface" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-r from-lime-500/[0.04] via-green-500/[0.04] to-emerald-500/[0.04] blur-[150px] rounded-full" />

        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8 lg:order-1 sr">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-lime-500/[0.08] border border-lime-500/15 backdrop-blur-sm">
                <div className="flex h-2 w-2 relative">
              ...
              <div>
                ...
                <p className="text-2xl text-transparent bg-clip-text bg-gradient-to-r from-lime-300 to-green-300 font-semibold">Feel Every Ball</p>
              </div>
              ...
              <div className="flex flex-wrap gap-3">
                <div className="px-4 py-2 rounded-xl glass flex items-center gap-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  { icon: <BarChart3 size={24} />, title: 'AI Analytics', desc: 'Momentum detection', color: 'text-lime-400' },
                  { icon: <Target size={24} />, title: 'Live Predictions', desc: 'Ball-by-ball accuracy', color: 'text-green-400' },
                  { icon: <Radio size={24} />, title: 'Real-Time Scores', desc: 'Instant updates', color: 'text-emerald-400' },
                  { icon: <Trophy size={24} />, title: 'Leaderboards', desc: 'Compete globally', color: 'text-yellow-400' },
                ].map((f, i) => (
                  <div key={i} className="group p-5 rounded-[1.25rem] glass hover:bg-lime-500/[0.04] hover:border-lime-500/15 transition-all duration-300">
                    <div className={`${f.color} mb-3`}>{f.icon}</div>
                    <h4 className="text-white font-semibold mb-1">{f.title}</h4>
                    <p className="text-sm text-slate-500">{f.desc}</p>
                  </div>
              ...
              <div className="pt-4">
                <button
                  ...
                  className="group px-8 py-4 rounded-full bg-gradient-to-r from-lime-500 to-green-500 text-black font-bold shadow-2xl shadow-lime-500/20 hover:shadow-lime-500/40 hover:scale-105 transition-all duration-300 flex items-center gap-3 btn-sweep"
                >
                  <Zap size={20} />
            ...
            <div className="relative lg:order-2 sr sr-delay-3">
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-gradient-to-r from-lime-500/[0.1] to-green-500/[0.1] blur-[100px] rounded-full animate-glow-pulse" />
              <div className="relative z-10 max-w-[480px] mx-auto transform hover:scale-[1.02] transition-transform duration-700">
                <div className="glass-strong rounded-[1.25rem] shadow-2xl shadow-lime-500/10 overflow-hidden ring-1 ring-lime-500/10">
                  <div className="bg-white/[0.03] px-4 py-3 flex items-center gap-2 border-b border-white/[0.04]">
                    <div className="flex gap-2">
                      <div className="w-3 h-3 rounded-full bg-white/10" />
                      <div className="w-3 h-3 rounded-full bg-white/10" />
                  ...
                  <div className="relative bg-surface h-[340px] overflow-hidden">
                      ...
                      <div className="p-5 space-y-3">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-white font-display font-bold">CricketBolt</span>
                          </div>
                        ...
                        <div className="glass rounded-[1rem] p-4">
                          ...
                          <div className="flex justify-between items-center">
                            <div className="text-center">
                              ...
                              <div className="text-lime-300 font-display font-bold text-lg">186/4</div>
                            </div>
                            <div className="text-slate-700 text-xs font-bold">VS</div>
                            <div className="text-center">
                              <div className="text-white font-bold text-sm">AUS</div>
                              <div className="text-slate-400 font-display font-bold text-lg">142/6</div>
                            </div>
                          </div>
                        </div>
      ...
      <section className="relative overflow-hidden py-32">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10 space-y-8 sr">
          ...
          <p className="text-xl text-slate-500">Join thousands of users across faith, health, and sports</p>
          <div className="flex flex-wrap justify-center gap-4 pt-6">
            ...
            <button
              onClick={() => window.open('https://cricketbolt.com/', '_blank')}
              className="px-8 py-4 rounded-full bg-lime-500/[0.08] border border-lime-500/15 text-lime-300 font-bold hover:bg-lime-500/[0.15] transition-all duration-300 flex items-center gap-2 hover:scale-105"
            >
              <Zap size={20} />
